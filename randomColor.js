...
;(function(root, factory) {
  ...
  // console.log("test false");
    //if (options.wantseed == undefined) {
      //console.log("first test option wantseed: est a 0 ");
      //options.wantseed= "0";
      //console.log(options.wantseed==="1");
    //}else {
      //console.log(options.wantseed===undefined);
      //console.log("first test option wantseed: "+options.wantseed);
    //}
    ...
    //  compareColors(colors[1],colors[2]);
    //console.log(colors);
      return colors;
    }
  ...
  }; // fin de fonction randommmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm
  ...
  function loadColorBounds () {
    ...
    defineColor(
      'red',
      [-26,18],
      [[10,100],[20,82],[30,92],[40,89],[50,85],[60,78],[70,70],[80,60],[90,55],[100,50]]
    );
